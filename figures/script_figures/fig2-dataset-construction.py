#!/usr/bin/env python3
"""Render the dataset-construction funnel used as Figure 2 of the paper.

Ported cell-for-cell from the historical 07_paper_visuals notebook rendering,
so the output stays pixel-identical to the figure the pipeline produced.
"""
...
save_fig(fig, 'fig2-dataset-construction')
plt.show()
