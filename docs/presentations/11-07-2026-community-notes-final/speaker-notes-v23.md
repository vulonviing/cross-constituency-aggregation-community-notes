# Community Notes Final Presentation V23 — Speaker Notes

Target delivery: **14:40**.

## 1–30. Existing Narrative

Use the delivery associated with V22. These slides are preserved without
changes.

## 31. Same Claim. Different Standard. — 0:45

Begin the results section with one focused case. The note on the left is
currently shown as Helpful and makes its factual point using graphic,
