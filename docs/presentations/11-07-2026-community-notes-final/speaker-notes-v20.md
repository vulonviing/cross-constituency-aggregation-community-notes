# Community Notes Final Presentation V20 — Speaker Notes

Target delivery: **14:40**.

## 1–30. Existing Narrative

Use the delivery associated with V19. These slides are preserved without
changes.
...
selected alternative reaches 79.6 percent and receives a canonical Gemma score
of 82. This is not proof that the shown note is false or that its author intended
to troll. It illustrates how the selection rule can favor a less provocative
formulation.
...
10,376 notes and validates 8,558 at the threshold of 50. This means the LLM
validates 62.7 percent of the original candidate universe. The final set contains
