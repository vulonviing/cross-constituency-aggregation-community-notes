...
Directory names follow `DD-MM-YYYY-<label>`.

| Directory | File | Content |
|---|---|---|
| `25-06-2026-1408-class_presentation/` | `CCA_presentation.key` | The June 2026 class presentation on CCA. |
| `11-07-2026-community-notes-final/` | `community-notes-final-presentation.pptx` | The final Community Notes talk. |

Both decks present the same pipeline and results the paper reports. For the
numbers behind any slide, see [REPRODUCING.md](../REPRODUCING.md).
